...
jQuery(window).load(function() {
    ...
    $('.opl-waypoint').css('marginTop', $('.opl-header').outerHeight(true) );
}
});
...
// ======================
var $head = $( '#opl-header' );
jQuery( '.opl-waypoint' ).each( function(i) {
    var $el = $( this ),
    ...
    $el.waypoint( function( direction ) {
        if( direction === 'down' && animClassDown ) {
            $head.attr('class', 'opl-header ' + animClassDown);
        }
        else if( direction === 'up' && animClassUp ){
            $head.attr('class', 'opl-header ' + animClassUp);
        }
    }, { offset: '-1px' } );
} );
...
var $head2 = $( '#opl-header2' );
jQuery( '.opl-waypoint2' ).each( function(i) {
    var $el = $( this ),
        animClassDown = $el.data( 'animateDown' ),
        animClassUp = $el.data( 'animateUp' );
    ...
    $el.waypoint( function( direction ) {
        if( direction === 'down' && animClassDown ) {
            $head2.attr('class', 'opl-header2 ' + animClassDown);
        }
        else if( direction === 'up' && animClassUp ){
            $head2.attr('class', 'opl-header2 ' + animClassUp);
        }
